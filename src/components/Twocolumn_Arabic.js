...
export default class TwoColumnArabic extends Component {
  state={
    searchModal:false,
    Lang:"ar",
  }
       ...
       <ScrollView>
                <View style={{width:"100%"}}>
                   <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Girl2,Lang:this.state.Lang})} style={{alignItems: 'center'}} activeOpacity={0.8}>
                    <ImageBackground source={Girl2} style={{width:"99%",height:350,alignItems:"center"}}>
         ...
         <Grid style={{marginTop:20}}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shorts,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
            ...
            <Col style={style.ColumnStyle}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shirt,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
          ...
          <Grid>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Tshirt,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    ...
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Lastree_Limited')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
                </TouchableOpacity> 
            </Col>
          ...
          <Grid>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Ladies,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    ...
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Ladies_Long')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
                </TouchableOpacity>
            </Col>
          ...
          <Grid>
            ...
            <Col style={style.ColumnStyle}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shoes,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    <Image source={Shoes} style={{width:150, height:200}} />
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Crocodile_Leather')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
                </TouchableOpacity>
            </Col>
          ...
          <Grid>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Bag1,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    <Image source={Bag1} style={{width:150, height:200}} />
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Orange_Ladies')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
                </TouchableOpacity>
            </Col>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Bag2,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    <Image source={Bag2} style={{width:150, height:200}} />
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Grey_Ladies')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
                </TouchableOpacity>
            </Col>
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Bag3,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                    <Image source={Bag3} style={{width:150, height:200}} />
                    <View style={{width:140,marginTop:5,alignItems:I18n.locale == 'ar'? "flex-end":"flex-start"}}>
                      <Text style={{color:"black",fontSize:12}}>{I18n.t('Grey_Ladies')}</Text>
                      <Text style={{color:"black",fontSize:10}}>$35.00</Text>
                    </View>
        ...
        <Modal style={style.BottomModal} onBackButtonPress={() => {this.setState({isModalVisible: false})}} animationInTiming={700} animationOutTiming={700} backdropOpacity={0.5} isVisible={this.state.isModalVisible}>
            <View style={{backgroundColor: "white",marginTop:10,marginLeft:10,marginRight:10,borderRadius:10}}>
              ...
              <View style={{justifyContent:"center",marginTop:10,flexDirection:"row",width:"100%",alignItems: 'center',height:80}}>
                  <TouchableOpacity onPress={() => this.props.navigation.navigate('TwoColumn',{Lang:this.state.Lang})} style={{width:"40%",alignItems: 'center',height:70,borderRadius:10,justifyContent: 'center',backgroundColor: "#42C2BF"}}>
                    <View>
