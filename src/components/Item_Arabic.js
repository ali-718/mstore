...
export default class ItemArabic extends Component {
      ...
      <View style={{flex:1,backgroundColor: "white",}}>
        ...
        <ScrollView style={{flex:1,width:"100%"}}>
            ...
            <View style={{flexDirection:'row',width:'100%',margin:20}}>
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:ShirtImage,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:Green,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:White,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:WhiteSecond,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}} >
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:Tshirt,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item2',{Picture:Ladies,Lang:this.state.Lang})} style={{marginLeft:10,marginTop:10,alignItems: 'center',}}>
