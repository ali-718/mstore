   ...
   flexDirection: 'row',
    ...
    return (
      ...
      <View style={style.txtView}>
          <TextInput onChangeText={(val) => {this.setState({Email:val})}} value={this.state.Email} style={style.txtInput} placeholder={I18n.t('Username')} placeholderTextColor="#A9A9A9"></TextInput>
          <TextInput secureTextEntry={true} onChangeText={(val) => {this.setState({Password:val})}} value={this.state.Password} style={style.txtInput} placeholder={I18n.t('Password')} placeholderTextColor="#A9A9A9"></TextInput>
      </View>
      <View style={{width:"80%", alignItems:"flex-end"}}>
      <TouchableOpacity onPress={() => this.props.navigation.navigate('Forgot',{Lang:this.state.Lang})}>
