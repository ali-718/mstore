...
export default class ListViewArabic extends Component {
  ...
  render() {
    ...
    const List_English = (
        <View style={{width:"90%"}}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shirt,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Green,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                        <Image style={{width:80,height:130,borderRadius:10,}} source={Green} />
                    </View>
                    <View style={{marginTop:10,marginLeft:10,width:"60%",height:130,}}>
                        <Text style={{color:"black",fontSize:20}}>
                        {I18n.t('Lastree_Limited')}
                        </Text>
                        <Text style={{color:"black",fontSize:13,marginTop:10}}>
                            $58.00
                        </Text>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:White,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:WhiteSecond,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Tshirt,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Ladies,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shoes,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                        <Image style={{width:80,height:130,borderRadius:10,}} source={Shoes} />
                    </View>
                    <View style={{marginTop:10,marginLeft:10,width:"60%",height:130,}}>
                        <Text style={{color:"black",fontSize:20}}>
                        {I18n.t('Crocodile_Leather')}
                        </Text>
                        <Text style={{color:"black",fontSize:13,marginTop:10}}>
                            $48.00
                        </Text>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Bag1,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
                        <Image style={{width:80,height:130,borderRadius:10,}} source={Bag1} />
                    </View>
                    <View style={{marginTop:10,marginLeft:10,width:"60%",height:130,}}>
                        <Text style={{color:"black",fontSize:20}}>
                        {I18n.t('Orange_Ladies')}
                        </Text>
                        <Text style={{color:"black",fontSize:13,marginTop:10}}>
                            $28.00
                        </Text>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Bag2,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%"}}>
                    <View style={{marginTop:10,width:80,}}>
    ...
    const List_Arabic = (
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Shirt,Lang:this.state.Lang})} style={{flexDirection:"row",width:"90%",alignItems: 'flex-end',}}>
                <View style={{flexDirection:"row",width:'100%',borderColor:"silver",height:150,alignItems:"center",justifyContent: 'flex-end',}}>
        ...
        {/* header End */}
            ...
            <View style={{backgroundColor: "white",marginTop:10,marginLeft:10,marginRight:10,borderRadius:10}}>
                ...
                <View style={{justifyContent:"center",marginTop:10,flexDirection:"row",width:"100%",alignItems: 'center',height:80}}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('ListView',{Lang:this.state.Lang})} style={{width:"40%",alignItems: 'center',justifyContent: 'center',height:70,borderRadius:10,backgroundColor: "#42C2BF"}}>
                        <View>
            ...
            <View style={{width:'100%',alignItems:"center",flex:1}}>
                <View style={{width:"100%"}}>
                   <TouchableOpacity onPress={() => this.props.navigation.navigate('Item',{Picture:Girl3,Lang:this.state.Lang})} style={{alignItems: 'center'}} activeOpacity={0.8}>
                    ...
                    {this.state.Lang == "ar" ? List_Arabic : List_English}
            </View>    
        </ScrollView>
        {/* Body ends */}
