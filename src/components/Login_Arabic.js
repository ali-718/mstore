...
export default class LoginArabic extends Component {
   ...
   flexDirection: 'row',
    ...
    return (
      ...
      <View style={style.txtView}>
          ...
          <TextInput onChangeText={(val) => {this.setState({Password:val})}} value={this.state.Password} style={style.txtInput} placeholder={I18n.t('Password')} placeholderTextColor="#A9A9A9"></TextInput>
      </View>
